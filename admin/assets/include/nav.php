        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="?page=tableProduct" class="sidebar-link">
                        <i class="bi bi-bag-fill"></i>
                        <span>Sản phẩm</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="?page=tableCategory" class="sidebar-link">
                        <i class="bi bi-bookmark-fill"></i>
                        <span>Loại sản phẩm</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="?page=tableComment" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a href="?page=tablePromotion" class="sidebar-link">
                ...
                <li class="sidebar-item ">
                    <a href="?page=logout" style="font-weight: bolder; font-size: 18px; color: red;" href="?page=home"
                       class="sidebar-link">
